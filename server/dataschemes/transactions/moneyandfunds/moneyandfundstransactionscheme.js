...
const transactionmessagescheme = require('../messages/transactionmessagescheme');

const moneyandfundstransactionscheme = new Schema(
{
...
module.exports = moneyandfundstransactionscheme;