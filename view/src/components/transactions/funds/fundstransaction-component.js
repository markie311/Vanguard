...
export default function FundsTransaction(props) {
 return (
  <Col xs={12}
       md={7}
       lg={7}
      ...
      <Col id='fundstransaction-fundstransactiongridcontainer-historycontainer'>
        {
          [].length === 0 ?
          (
           <p id='fundstransaction-fundstransactiongridcontainer-historycontainer-notransactionsheaderindication'>No transaction's</p>
          )
          :
          (
           <React.Fragment>
