...
export default function LandingPageIntroduction() {
 return(
   <Row id='landingpageintroduction'>
     ...
     <h1 className='landingpageintroduction-header landingpageintroduction-hereandisubheader'>Happy here's, finally for that what is lost, comfort's going back will be the decision, I's, as whole and complete</h1>
    <Col id='landingpageintroduction-container'>
     <h1 className='landingpageintroduction-containerheader landingpageintroduction-containerheader-xirbitheader'>XIRBIT</h1>
